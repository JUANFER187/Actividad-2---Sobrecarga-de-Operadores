...
int main()
{
    ...
    Empleado JefePlanta(123456, "Dr. Pepe Pecas", "TodoVerde 443", 75000.99, "Ricardo Kaka");
    Empleado JefePersonal(234567, "Mtro. Paco Cabeza", "Cerro Divino 666", 47999.49, "Dr. Pepe Pecas");
    std::cin>>JefePlanta;
    ...
    do
    {
        ...
        case OPT_CONSULTA:
            ...
            cout << "Intenta con las claves 123456 y 234567." << endl;
            cin >> clave;
